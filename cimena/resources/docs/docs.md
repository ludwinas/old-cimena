...
* Update the connection parameters for the database in the `cimena.db.schema` namespace of your application.
...
Request middleware functions are located under the `cimena.middleware` namespace.
